...
public class PostCommentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rooView = inflater.inflate(R.layout.fragment_post_comment, container, false);
    ...
    public void send_data(View rooView) {

        name_layout = rooView.findViewById(R.id.name_layout);
        name_text = rooView.findViewById(R.id.name_text);
        name_text.requestFocus();

        comment_layout = rooView.findViewById(R.id.comment_layout);
        comment_text = rooView.findViewById(R.id.comment_text);

        email_text = rooView.findViewById(R.id.email_text);
        tel_text = rooView.findViewById(R.id.tel_text);
        web_text = rooView.findViewById(R.id.web_text);

        submit_btn = rooView.findViewById(R.id.submit_bt);
                ...
                if(response.trim().equals("ok"))
                {
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Toast.makeText(getContext(),"آگهی با موفقیت ارسال شد",Toast.LENGTH_SHORT).show();
                        }
                    });
                }
                else
                {
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Toast.makeText(getActivity().getBaseContext(),"خطا در ارسال آگهی",Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
