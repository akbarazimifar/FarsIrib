...
public class ResideMenu extends FrameLayout{
    ...
    private void initViews(Context context){
        ...
        scrollViewMenu = findViewById(R.id.sv_left_menu); //change to sv_right_menu for right
        imageViewShadow = findViewById(R.id.iv_shadow);
        layoutLeftMenu = findViewById(R.id.layout_left_menu); //change to layout_right_menu for right
