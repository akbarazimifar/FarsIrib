...
public class KhoshaActivity extends Main2Activity {

    private int page_index;
    private Context myContext;
    ArrayList<JSONObject> data_list;
    private String URL;
    public ImageView khosha_header, ertebatbama, moarefi_mehman,like,khosha_archive,khosha_gallary,khosha_ugc;
    String page_url = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getLayoutInflater().inflate(R.layout.activity_khosha, content_frame);
        ...
        if (settings.getInt("user_id",0)!=0)
        {
            ...
            new OptionTask(9).execute(); // Items of Chelcheragh page
        ...
        khosha_header = findViewById(R.id.khosha_header);
        ertebatbama = findViewById(R.id.ertebatbama);
        like = findViewById(R.id.like);
      //  moarefi_mehman = findViewById(R.id.moarefi_mehman);
        khosha_archive = findViewById(R.id.khosha_archive);
        khosha_ugc = findViewById(R.id.khosha_ugc);
     //   khosha_gallary = findViewById(R.id.khosha_gallary);

        ertebatbama.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(KhoshaActivity.this, PostCommentActivity.class);
                intent.putExtra("title","ارتباط با ما" );
                intent.putExtra("caller_context","KhoshaActivity" );
                startActivity(intent);
            }
        });

        khosha_archive.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(KhoshaActivity.this, WebMainPageActivity.class);
...
//        khosha_gallary.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                Toast.makeText(getBaseContext(), "در نسخه های بعدی عملیاتی خواهد شد!!", Toast.LENGTH_SHORT).show();
//            }
//        });
        ...
        khosha_ugc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(KhoshaActivity.this, UGCActivity.class);
                intent.putExtra("title","در شبکه فارس دیده شوید" );
                intent.putExtra("caller_activity","KhoshaActivity" );
                startActivity(intent);
            }
        });
    }
    ...
    private void FillData() throws JSONException {
        ...
        for (int i = 0; i < data_list.size(); i++) {
            ...
            switch (i) {
                case 0:
                    Glide.with(this).load(URL).apply(requestOptions).into(khosha_header);
                    break;
                case 1:
...
//                    break;
                case 4:
                    ...
                    Glide.with(this).load(URL).apply(requestOptions).into(khosha_archive);
                    break;
//                case 5:
//                    Glide.with(this).load(URL).apply(requestOptions).into(khosha_gallary);
//                    break;
                case 6:
                    Glide.with(this).load(URL).apply(requestOptions).into(khosha_ugc);
                    break;
            }
        }
    }
