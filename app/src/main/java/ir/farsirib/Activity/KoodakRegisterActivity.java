...
public class KoodakRegisterActivity extends Main2Activity {
    ...
    private JSONObject new_koodak_register;
        ...
        submit_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (is_validate) {
                    ...
                    new_koodak_register =new JSONObject();

                    try {

                        new_koodak_register.put("koodak_name",name_text.getText().toString().trim());
                        new_koodak_register.put("koodak_sex",radioSexButton.getText().toString().trim());
                        new_koodak_register.put("koodak_age",age_text.getText().toString().trim());
                        new_koodak_register.put("koodak_city",city_text.getText().toString().trim());
                        new_koodak_register.put("koodak_mobile",mobile_text.getText().toString().trim());

                        new_koodak_register.put("command","new_koodak_register");
    ...
    private class send_koodak_info extends AsyncTask<Void,Void,String> {

        ProgressDialog pd=new ProgressDialog(KoodakRegisterActivity.this);
        ...
        protected String doInBackground(Void... voids) {
            ...
            namevaluepairs.add(new BasicNameValuePair("myjson",new_koodak_register.toString()));
